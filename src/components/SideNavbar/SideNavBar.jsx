...
const SideNavBar = () => {
    ...
    const toggleSideBarView = () => {
        ...
        document.querySelector('#floating-side-bar-overlay').classList.remove(`${navStyles['activer-overlay']}`);
        document.querySelector('#floating-side-bar').classList.remove(`${navStyles['active-side-bar']}`);

    }

    return (
        <>
           <div className={navStyles['floating-side-bar-overlay']} id='floating-side-bar-overlay' onClick={toggleSideBarView}>

                {/* <!-- START OF SIDE BAR --> */}
                <div className={navStyles['floating-side-bar']} id='floating-side-bar'>
